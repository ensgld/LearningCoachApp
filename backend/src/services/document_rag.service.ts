...
export async function chatWithDocument(params: {
    ...
    let answer = await answerWithContext(params.question, context, params.history ?? []);
...
export async function generateQuiz(params: {
    ...
    const data = await llmGenerateQuiz(context.slice(0, 8000), params.count, params.difficulty, params.instructions);
