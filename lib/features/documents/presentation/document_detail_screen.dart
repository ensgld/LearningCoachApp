          ...
          children: [
            ...
            SizedBox(
              ...
              child: OutlinedButton.icon(
                ...
                label: Text(AppStrings.getPrepareTest(locale)),
            ...
            SizedBox(
              ...
              child: OutlinedButton.icon(
                ...
                label: Text(AppStrings.getCreateFlashcards(locale)),
                style: OutlinedButton.styleFrom(
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    '${session.difficultyLabel} · ${session.questionCount} soru',
                    style: TextStyle(
                      fontSize: 12,
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 4),
                  Text(
                    '${set.difficultyLabel} · ${set.cardCount} kart',
                    style: TextStyle(
                      fontSize: 12,
                      color: scheme.onSurfaceVariant,
                    ),
      ...
      child: Row(
        children: [
          ...
          IconButton(
            ...
            onPressed: () => Navigator.of(context).push(
              MaterialPageRoute<void>(
                builder: (_) => FlashcardStudyScreen(set: set),
              ),
            ),
            tooltip: 'Hemen Çalış',
          ),
